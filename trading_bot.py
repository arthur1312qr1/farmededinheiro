        ...
        with self.position_lock:
            try:
                ...
                try:
                    ...
                    # Targets extremos - MANTENDO VALORES ORIGINAIS
        ...
        try:
            with self._lock:
                ...
                if profit_deficit > 5.0:  # Mais de 5% atrás
                    ...
                    # MANTER take profit alto para garantir lucro líquido - NÃO ALTERAR
                    # self.profit_target permanece em 0.012 (1.2%)
                ...
                # Se na meta ou à frente, aumentar qualidade
                    ...
                    # Aumentar take profit para maior qualidade - MAS MANTER MÍNIMO
                ...
                if self.consecutive_losses >= 1:
                    ...
                    # MANTER take profit em 1.2% para garantir lucro líquido
...
class TradingBot:
    def __init__(self, bitget_api: BitgetAPI, symbol: str = 'ETHUSDT',
        ...
        logger.info("⚡ CONFIGURAÇÕES EXTREMAS CORRIGIDAS:")
